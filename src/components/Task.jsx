...
export function TaskCard({ status = "PENDING", startDate = "Mar 30", endDate = "Apr 13", isExpand = false }) {
  ...
  return (
    <Card className={`shadow-sm border  p-[10px] ${BoxStyles[status]}  shadow-[0_2px_15px_0_#0000001A]`}>
      <CardHeader className="flex flex-row p-0 justify-between items-center mb-[10px] bg-transparent">
