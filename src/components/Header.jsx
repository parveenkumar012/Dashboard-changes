    ...
    return (
        <div className="flex items-center justify-between flex-wrap">
          ...
          <div className="flex  items-center justify-between w-full px-[10px] md:px-[30px]  py-[15px]">
            {/* Back Button */}
            <Button  className="flex items-center rounded-[10px] text-gray-600 bg-[#F1F5F9] shadow-none hover:bg-[#1B1B1B]  group h-[35px] md-h-[36px] py-[5px] md:py-[8px] px-[5px] md:px-[10px]">
            ...
            <div className="flex gap-x-[5px] md:gap-x-[15px]">
              <Button className="w-[26px] h-[26px] md:w-[41px] md:h-[41px] p-0 flex items-center justify-center [&_svg]:size-[20px] bg-[#F1F5F9] rounded-[9px] shadow-none hover:bg-secondary "><img src={graduationCap} alt="" /></Button>
              <div className="w-[26px] h-[26px] md:w-[41px] md:h-[41px] flex items-center justify-center relative">
                <Button className="p-0 h-auto hover:bg-transparent w-[41px] bg-transparent shadow-none" >
              ...
              <div className="flex items-center gap-x-[5px] md:gap-x-[15px]">
                ...
                <span className="text-[#4A505A] text-[10px] md:text-sm font-['Inter']">Product Manager</span>
